class googlepay:
    ...
    def link(self):
        ...
        print("link with google acc")


customer=googlepay("qr","phoneno","banktransfer","mobilerecharge","upiid","selftransfer","checkbal","paybill")
customer.display()
customer.promotions()
...
if ("bank account number<12"):
    ...
    if ("linkedproperly"):
        print("welcome to Gpay,have a good day!")
